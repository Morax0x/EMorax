...
function setupDatabase(sql) {
    ...
    const tables = [
        ...
        // 🔥 تم تصحيح هذا السطر بإزالة emojis_sent المكررة من النهاية 🔥
    ...
    // Perform Migrations
    ['mora', 'lastWork', 'lastDaily', 'dailyStreak', 'bank', 'lastInterest', 'totalInterestEarned', 'hasGuard', 'guardExpires', 'lastCollected', 'totalVCTime', 'lastRob', 'lastGuess', 'lastRPS', 'lastRoulette', 'lastTransfer', 'lastDeposit', 'shop_purchases', 'total_meow_count', 'boost_count', 'lastPVP', 'lastFarmYield', 'lastFish', 'rodLevel', 'boatLevel', 'lastMemory', 'lastArrange', 'last_dungeon'].forEach(col => ensureColumn('levels', col, 'INTEGER DEFAULT 0'));
