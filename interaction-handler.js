...
// 🆕 استدعاء ملف المزرعة (إذا كان منفصلاً، أو الاعتماد على shop-handler إذا تم الدمج)
// بما أنك طلبت الدمج، سنعتمد على shop-handler، ولكن سأبقي هذا الاستدعاء احتياطاً إذا كان الملف موجوداً لديك
        ...
        try {
            ...
            if (i.isButton()) {
                ...
                // ✅ أزرار المتجر والصيد والسوق والمزرعة (إذا دمجت في shop-handler)
                    ...
                    id === 'cast_rod' || id.startsWith('pull_rod') || // أزرار الصيد
                    id.startsWith('sell_') // أزرار البيع في السوق
                ) {
            ...
            if (i.isModalSubmit()) {
                ...
                // ( 🌟 هنا يتم معالجة مودالات المتجر والسوق والمزرعة 🌟 )
